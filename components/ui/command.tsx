...
function CommandDialog({
  ...
  /** Předává se dovnitř <Command> — false vypne vestavěné filtrování cmdk. */
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* sr-only header musí být UVNITŘ DialogContent, jinak Radix
            nenajde DialogTitle (a11y warning, rozbité aria-labelledby) */}
